...
<head>
  ...
  <title>Account Settings | ABET Tools</title>
  <style>
...
<body>
  <div class="card">
    ...
    <ul>
      <li><a href="/account/settings/email/">Change Email</a></li>
      <li><a href="/account/settings/password/">Reset Password</a></li>
      <li><a href="/account/settings/sessions/">Manage Sessions</a></li>
    </ul>
  </div>
</body>
</html>